...
class CategoryImMemoryRepository(CategoryRepository, InMemorySearchableRepository):
  ...
  def _apply_sort(self, items: List[Category], sort: str | None, sort_dir: str) -> List[Category]:
