...
class TestInMemoryRepository(unittest.TestCase):
    ...
    def test_raise_not_found_exception_in_find_by_id(self):
        ...
        self.assertEqual(
            assert_error.exception.args[0],
            "Entity not found using ID 'c71404e4-1a1f-4587-9ff1-5e6b90589a81'"
        )
...
class TestSeaerchParams(unittest.TestCase):
    ...
    def test_sort_dir(self):
        ...
        for i in arrange:
            params = SearchParams(sort='nome', sort_dir=i['sort_dir'])
...
class TestSeaerchResult(unittest.TestCase):
    ...
    def test_when_per_page_is_less_than_total(self):
        result = SearchResult(
            items=[],
            total=101,
            current_page=1,
...
class StubImMemorySearchableRepository(InMemorySearchableRepository[StubEntity, str]):
...
class TestImMemorySearchableRepository(unittest.TestCase):
    repo: StubImMemorySearchableRepository

    def setUp(self) -> None:
        self.repo = StubImMemorySearchableRepository()
